	...
	def read(self):
		try:
			...
			if self.state == 2:
				...
				print ('creating new cc: ', ccportnum)
...
class CC(object):
	...
	def write(self):
		if self.state == 0:
			...
			# self.sock.sendto(b'CMD 000143\r\n1\r\n1HISENSE_DELIMITER2HISENSE_DELIMITER2HISENSE_DELIMITERKEY_VOLUMEDOWNHISENSE_DELIMITER10HISENSE_DELIMITER0HISENSE_DELIMITER0\r\n\r\n\0', self.host)
			# self.sock.sendto(b'CMD 000143\r\n1\r\n1HISENSE_DELIMITER2HISENSE_DELIMITER2HISENSE_DELIMITERKEY_VOLUMEDOWNHISENSE_DELIMITER10HISENSE_DELIMITER0HISENSE_DELIMITER0\r\n\r\n\0', self.host)
			# self.sock.sendto(b'CMD 000143\r\n1\r\n1HISENSE_DELIMITER2HISENSE_DELIMITER2HISENSE_DELIMITERKEY_VOLUMEDOWNHISENSE_DELIMITER10HISENSE_DELIMITER0HISENSE_DELIMITER0\r\n\r\n\0', self.host)
...
def usage():
	...
	print ("any other input is considered a command to send to the TV\n")
	sys.exit()
